...
def constraint_n2(xx, t):
    return xx.power_out_ele[t] == xx.power_in_ht[t] + xx.power_out_ele_bur[t]
...
def func_object(xx):
    C_npc_CAPEX = xx.power_rated_ele*xx.CAPEX_ele + xx.power_rated_bur*xx.CAPEX_bur + xx.capacity_rated_ht*xx.CAPEX_ht
    C_npc_OPEX = xx.power_rated_ele*xx.OPEX_ele + xx.power_rated_bur*xx.OPEX_bur + xx.capacity_rated_ht*xx.OPEX_ht
